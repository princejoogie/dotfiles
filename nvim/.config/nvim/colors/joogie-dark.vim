...
hi jsImport guifg=#9cdcfe ctermfg=176 gui=italic cterm=italic
hi jsFrom guifg=#9cdcfe ctermfg=176 gui=italic cterm=italic
hi jsModuleAs guifg=#9cdcfe ctermfg=176 gui=italic cterm=italic
hi jsExport guifg=#9cdcfe ctermfg=116 gui=NONE cterm=NONE
hi jsExportDefault guifg=#9cdcfe ctermfg=116 gui=NONE cterm=NONE
hi jsExtendsKeyword guifg=#9cdcfe ctermfg=176 gui=italic cterm=italic
...
hi shComment guifg=#637777 ctermfg=243 guibg=#000000 ctermbg=233 gui=italic cterm=italic
...
hi jsxComponentName guifg=#2dc9b0 ctermfg=222 gui=NONE cterm=NONE
