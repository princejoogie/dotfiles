...
keymap("n", "gG", "50%")
keymap("n", "gf", "<C-W>f")
keymap("n", "<leader>bd", ":bufdo bd<CR>:NvimTreeOpen<CR>")
...
pcall(function()
	...
	keymap("n", "<leader>gs", custom.git_status)
	keymap("n", "<leader>gc", custom.git_commits)
	keymap("n", "<leader>gb", custom.git_bcommits)
