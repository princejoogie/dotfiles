  ...
  config = function()
    ...
    conform.setup({
      formatters_by_ft = {
        ...
        lua = { "stylua" },
        python = { "isort", "black" },
        javascript = { "prettier", "eslint_d", "biome", "oxfmt" },
        typescript = { "prettier", "eslint_d", "biome", "oxfmt" },
        javascriptreact = { "prettier", "eslint_d", "biome", "oxfmt" },
        typescriptreact = { "prettier", "eslint_d", "biome", "oxfmt" },
        svelte = { "prettier" },
        css = { "prettier", "biome" },
        html = { "prettier", "biome" },
        json = { "prettier", "biome" },
